...
struct DebugMenu: Commands {
    ...
    private func handleAddAgent() {
        ...
        do {
            ...
            LoomLog.ui.info("Added coding agent \(details.name, privacy: .public)")
        } catch {
    ...
    private func handleRemoveAgent() {
        ...
        do {
            ...
            LoomLog.ui.info("Removed coding agent \(picked.name, privacy: .public)")
        } catch {
    ...
    private func handleSetDefaultAgent() {
        ...
        do {
            ...
            LoomLog.ui.info("Default coding agent is now \(picked.name, privacy: .public)")
        } catch {
