...
enum SidebarActions {
    ...
    static func openInFinder(path: String) {
        ...
        LoomLog.ui.info("Reveal in Finder: \(path, privacy: .public)")
    }
    ...
    static func openInTerminal(path: String) {
        ...
        NSWorkspace.shared.open(
            ...
            if let error {
                LoomLog.ui.error("Open Terminal.app failed: \(String(describing: error), privacy: .public)")
            } else {
                LoomLog.ui.info("Opened Terminal.app at \(path, privacy: .public)")
            }
        }
    }
    ...
    static func removeTab(id: Int64, services: AppServices) {
        ...
        do {
            ...
            LoomLog.ui.error("Failed to delete tab \(id, privacy: .public): \(String(describing: error), privacy: .public)")
        }
